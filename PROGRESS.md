...
- [ ] Phase B3 · Assembly Scan atomic + PWA UI
- [ ] Phase B4 · ECO workflow UI (list/new/detail + affected orders)
- [ ] Phase B5 · Lot E2E page `/lot-serial/[id]` timeline
- [ ] Phase B6 · QC in-process checkpoint UI
