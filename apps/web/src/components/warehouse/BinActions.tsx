    ...
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent size="md">
        <DialogHeader>
          <DialogTitle>
            Thêm hàng vào{" "}
            <code className="font-mono text-indigo-700">{bin.fullCode}</code>
          </DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            {!selectedItem ? (
              ...
              <div className="mt-1 flex items-center justify-between rounded-md border border-indigo-200 bg-indigo-50 px-3 py-2">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-md bg-zinc-50 p-3 text-xs">
            ...
            <div className="mt-1 flex justify-between">
              <span className="text-zinc-500">Tồn hiện tại:</span>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full rounded-md border border-zinc-300 bg-white px-2 py-1.5 font-mono text-sm"
            >
