      ...
      <PopoverTrigger asChild disabled={disabled}>
        <button
          ...
          className={cn(
            ...
            "hover:bg-zinc-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500 focus-visible:outline-offset-0 dark:hover:bg-zinc-800/60",
          ...
          <span className="flex items-center gap-1">
            {value && allowClear && !disabled && (
              <span
                ...
                className="inline-flex h-5 w-5 items-center justify-center rounded-sm text-zinc-400 hover:bg-zinc-100 hover:text-zinc-700 dark:text-zinc-500 dark:hover:bg-zinc-800 dark:hover:text-zinc-300"
            ...
            return (
              <li key={r.id}>
                <button
                  ...
                  className={cn(
                    "flex w-full items-start gap-2 rounded-sm px-2 py-1.5 text-left text-base transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-800/60",
                    selected && "bg-indigo-50 dark:bg-indigo-500/10",
                  )}
                >
                  <span className="mt-0.5 w-20 shrink-0 truncate font-mono text-xs text-zinc-500 dark:text-zinc-400">
                    {r.code}
                  </span>
                  ...
                  {selected && (
                    <Check
                      className="mt-1 h-3.5 w-3.5 shrink-0 text-indigo-600 dark:text-indigo-400"
                      aria-hidden="true"
                    />
                  )}
                </button>
