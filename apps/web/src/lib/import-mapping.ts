...
export const ITEM_FIELD_SYNONYMS: Record<string, string[]> = {
  ...
  category: [
    ...
    "cat",
    "chungloai",
    // V3.7.13 — Excel "Category" (mã 4 số) + Sub Category cho material
    "categoryno",
    "macategory",
  ],
  minStock: [
  ...
  // V3.7.13 — Extended fields cho "Bản chính thức" BOM Excel.
  // Lưu vào item.specJson / item.metadata cho phase 1, không cần cột riêng.
  qtyPerSet: [
    "qtyperset",
    "qtyperunit",
    "quantityperset",
