    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
          <div className="grid h-9 grid-cols-[1fr,1.2fr,100px] items-center gap-3 border-b border-zinc-200 bg-zinc-50/70 px-4 text-[11px] font-semibold uppercase tracking-normal text-zinc-500 md:grid-cols-[1fr,1.2fr,1.3fr,1.4fr,100px,120px,90px]">
            <span>Username</span>
            <span>Họ tên</span>
          ...
          {query.isLoading ? (
            ...
            <ul className="divide-y divide-zinc-100">
              {rows.map((u) => (
                <li
                  key={u.id}
                  className="group grid min-h-[40px] grid-cols-[1fr,1.2fr,100px] items-center gap-3 px-4 py-2 transition-colors hover:bg-indigo-50/40 md:grid-cols-[1fr,1.2fr,1.3fr,1.4fr,100px,120px,90px]"
                >
                  <Link
                    href={`/admin/users/${u.id}`}
                    className="truncate font-mono text-xs font-semibold text-indigo-600 hover:text-indigo-700 hover:underline"
                  >
                    {u.username}
                  </Link>
