  ...
  return (
    <div className="flex h-full flex-col">
        ...
        <div className="mt-2 flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Materialized view shortage filtered theo BOM này.
            </p>
          </div>
      ...
      <div className="flex-1 overflow-auto p-6">
        <EmptyState
          preset="no-data"
          title="Chưa có thiếu hàng"
          description="Tình trạng thiếu hàng tính từ snapshot_line per-component. Phase 4 sẽ wire `/api/shortage?bomTemplateId=X`."
        />
      </div>
    </div>
  );
