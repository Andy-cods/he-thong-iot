        ...
        <div className="flex items-center gap-1.5">
          {(["all", "PENDING", "PICKING", "READY", "DELIVERED", "CANCELLED"] as const).map((s) => {
            ...
            return (
              ...
              >
                {cfg && (
                  <span className={cn("h-1.5 w-1.5 rounded-full", active ? cfg.dot : "bg-zinc-300 dark:bg-zinc-600")} />
                )}
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-zinc-100 bg-zinc-50/60 dark:border-zinc-800 dark:bg-zinc-800/60">
                  <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Mã yêu cầu</th>
                  <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Người yêu cầu</th>
                  <th className="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Số dòng</th>
                  ...
                  <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Ngày tạo</th>
                  <th className="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Hành động</th>
                </tr>
              </thead>
              <tbody>
                {rows.map((r) => {
                  ...
                  return (
                    <tr key={r.id} className="group border-b border-zinc-50 transition-colors hover:bg-zinc-50/70 dark:border-zinc-800/60 dark:hover:bg-zinc-800/60">
                      ...
                      <td className="px-5 py-3.5 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Link
                            href={`/material-requests/${r.id}`}
                            className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-zinc-400 hover:bg-zinc-100 hover:text-indigo-600 transition-colors dark:text-zinc-500 dark:hover:bg-zinc-800 dark:hover:text-indigo-400"
                          >
